...
<title>Donar Update Registration</title>
</head>
<%@ include file="header.jsp"%>
<body class="container">
	<h1 class="text-warning" style="text-align: center">Donar Update Form</h1>
	
	<div class="form">
		<form:form action="/updateGotId" modelAttribute="donarObj" method="get">
